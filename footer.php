    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          ...
          <div class="credits">
            Designed And Developed By TC-1 Batch (Marwadi University)
          </div>
          <div class="col-md-2 col-sm-3" style='float:right;'>
            <input type="hidden" id="is_active_group_chat_window" value="no" />
            <button type="button" name="group_chat" id="group_chat" >
            <i class='far fa-comments'style='font-size:50px;color:blue'></i></button>
        </div>
  ...
  <div class="chat_message_area">
   ...
   <div class="image_upload">
    <form id="uploadImage" method="post" action="chatupload.php">
     <label for="uploadFile"><i class="fa fa-image" style="font-size:24px;color:blue"></i></label>
